    ...
    <body>
        ...
        <main>
            ...
            <form method="post"action="update_confirm.php">
                ...
                <div>
                    <label>カナ（名）　　</label>
                    <input type="text"class="text"size="20"name="kana_name"maxlength="10"pattern="^[ァ-ンヴー]+$"value="<?php echo $row['last_name_kana'];?>">
                ...
                <div>
                    ...
                    <input type="radio"name="gender"value="女"<?php if(!empty($row['gender'] && $row['gender']=="1")) echo 'checked'?>>女
                </div>
                <div>
                    <label>郵便番号　　</label>
                ...
                <div>
                    ...
                    <select class="dropdown"name="authority">
                        <option value="一般"<?php if($row['authority']=="0"){echo "selected";}?>>一般</option>
                        <option value="管理者"<?php if($row['authority']=="1") {echo "selected";}?>>管理者</option>
                    </select>
                </div>
                <br>
